...
class FeedPrice extends Price {
  ...
  getSqueezePrice({ real = false } = {}) {
    if (!this._squeeze_price) {
      ...
      if (this.inverted)
        this._squeeze_price.base.amount = Math.floor(this._squeeze_price.base.amount * this.sqr)
      if (!this.inverted)
        this._squeeze_price.quote.amount = Math.floor(this._squeeze_price.quote.amount * this.sqr)
    }
