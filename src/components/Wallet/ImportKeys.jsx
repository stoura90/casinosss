...
import BalanceClaimAssetTotal from './BalanceClaimAssetTotal'
...
class ImportKeys extends Component {
    ...
    WalletDb.importKeysWorker(private_key_objs)
      .then((result) => {
        ...
        NotificationActions.success(
          counterpart.translate('wallet.import_key_success', { count: import_count }),
        )
        this.setState({
          importSuccess: true,
        })
  ...
  render() {
    ...
    let was_filtered =
      !!this.state.genesis_filter_status.length && this.state.genesis_filter_finished
                ...
                {privateKey ? (
                  ...
                  <form onSubmit={this._passwordCheck.bind(this)}>
                    ...
                    <div className="button-group">
                      <button
                        className={cname('button', { disabled: !!this.state.no_file })}
                        type="submit"
                      >
                        <Translate content="wallet.submit" />
                      </button>
