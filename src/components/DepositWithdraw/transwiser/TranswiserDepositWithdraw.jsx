...
class TranswiserDepositWithdraw extends React.Component {
  ...
  requestDepositUrl() {
    let pair =
      this.depositCoin.toLocaleLowerCase() +
      ':' +
      this.props.receiveAsset.get('symbol').toLocaleLowerCase()
  ...
  getModalId() {
    return (
      '_asset_' + this.props.issuerAccount.get('name') + '_' + this.props.receiveAsset.get('symbol')
    )
  }
  ...
  render() {
    ...
    if (!this.props.account || !this.props.issuerAccount || !this.props.receiveAsset) return loading
      ...
      <tr>
        ...
        <td>
          ...
          <AccountBalance
            ...
            asset={this.props.receiveAsset.get('symbol')}
          />{' '}
        </td>
        <td>
