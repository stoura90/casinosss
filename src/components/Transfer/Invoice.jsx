      ...
      return (
        <div>
          ...
          <h4 className="has-error text-center">
            Asset {this.state.invoice.currency} is not supported by this blockchain.
          </h4>
        </div>
      )
        ...
        <tr>
          <td>
            ...
            <div className="item-description">
              {i.quantity} x {<FormattedAsset amount={i.price} asset={asset} exact_amount={true} />}
            </div>
          </td>
          <td>
            ...
            <div>
              ...
              <table className="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <FormattedAsset amount={total_amount} asset={asset} exact_amount={true} />
                    </td>
                  </tr>
                </tbody>
              </table>
              ...
              <form>
                ...
                <a href className={payButtonClass} onClick={this.onPayClick.bind(this)}>
                  Pay <FormattedAsset amount={total_amount} asset={asset} exact_amount={true} /> to{' '}
                  {invoice.to}
                </a>
              </form>
            </div>
