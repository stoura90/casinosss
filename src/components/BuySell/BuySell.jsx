...
class BuySell extends React.Component {
  ...
  static propTypes = {
    ...
    baseAsset: ChainTypes.ChainAsset,
    quoteAsset: ChainTypes.ChainAsset,
    history: ChainTypes.ChainObject,
  }
              ...
              <div className="grid-block BuySell__inputs">
                <div className="grid-content small-6">
                  ...
                  <p>
                    ...
                    <span className="float-right">
                      {buyOrder.getTotalString()} <AssetName name={baseSymbol} />
                    </span>
                  </p>
                </div>
                ...
                <div className="grid-content small-6">
                  ...
                  <p>
                    Total:{' '}
                    <span className="float-right">
                      {sellOrder.getTotalString()} <AssetName name={baseSymbol} />
                    </span>
                  </p>
                </div>
              </div>
