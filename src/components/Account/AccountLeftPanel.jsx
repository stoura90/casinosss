  ...
  render() {
    ...
    linkBtn = isMyAccount ? null : linkedAccounts.has(account_name) ? (
      <a
        ...
        href
        className="button outline block-button"
          ...
          <div className="grid-content no-padding" style={{ overflowX: 'hidden' }}>
            <div className="regular-padding">
              <AccountInfo
                ...
                image_size={{ height: 90, width: 90 }}
                my_account={isMyAccount}
              />
              <div className="grid-container no-margin">
                {linkBtn}
                <Link className="button outline block-button" to={`/transfer/?to=${account_name}`}>
                  <Translate content="account.pay" />
                </Link>
              </div>
            </div>
            <section className="block-list">
              <ul className="account-left-menu" style={{ marginBottom: 0 }}>
                <li>
                  <Link to={`/account/${account_name}/overview/`} activeClassName="active">
                    <Translate content="account.overview" />
                  </Link>
                </li>
                <li>
                  <Link to={`/account/${account_name}/member-stats/`} activeClassName="active">
                    <Translate content="account.member.stats" />
                  </Link>
                </li>
                <li>
                  <Link to={`/account/${account_name}/orders/`} activeClassName="active">
                    <Translate content="account.open_orders" />
                  </Link>
                </li>
                <li>
                  <Link to={`/account/${account_name}/voting/`} activeClassName="active">
                ...
                {isMyAccount ? (
                  <li>
                    <Link
                      to={`/account/${account_name}/deposit-withdraw/`}
              ...
              {this.state.showAdvanced ? (
                <ul className="account-left-menu">
                  <li>
                    <Link to={`/account/${account_name}/assets/`} activeClassName="active">
                      <Translate content="explorer.assets.title" />
                    </Link>
                  </li>
                  <li>
                    <Link to={`/account/${account_name}/permissions/`} activeClassName="active">
                      <Translate content="account.permissions" />
                    </Link>
                  </li>
                  <li>
                    <Link to={`/account/${account_name}/whitelist/`} activeClassName="active">
          ...
          <div className="grid-block shrink bottom">
            <div className="center">
              <div
                ...
                data-tip={counterpart.translate('account.create_new')}
                data-place="top"
              >
