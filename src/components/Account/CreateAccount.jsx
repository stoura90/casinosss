...
class CreateAccount extends React.Component {
  ...
  _renderAccountCreateForm() {
    ...
    let buttonClass = classNames('button no-margin', {
      disabled: !valid || (registrar_account && !isLTM),
    })

    return (
      <form style={{ maxWidth: '40rem' }} onSubmit={this.onSubmit.bind(this)} noValidate>
        <AccountNameInput
          ref={(ref) => {
            if (ref) {
  ...
  _renderBackupText() {
    return (
      <div>
        ...
        <p>
          <Translate content="wallet.wallet_crucial" />
        </p>
        <p>
          <Translate content="wallet.wallet_move" />
        </p>
        <p>
          <Translate content="wallet.wallet_lose_warning" />
        </p>
      </div>
    )
  }
          ...
          <div style={{ textAlign: 'center', paddingTop: 20 }}>
            ...
            <h4 style={{ paddingTop: 20 }}>
              {step === 1 ? (
                ...
                <Translate content="wallet.create_success" />
              ) : (
