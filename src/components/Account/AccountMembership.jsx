...
class AccountMembership extends React.Component {
  ...
  render() {
    ...
    let lifetime_cost =
      (gprops.getIn(['parameters', 'current_fees', 'parameters', 8, 1, 'membership_lifetime_fee']) *
        gprops.getIn(['parameters', 'current_fees', 'scale'])) /
      10000
    let annual_cost =
      (gprops.getIn(['parameters', 'current_fees', 'parameters', 8, 1, 'membership_annual_fee']) *
        gprops.getIn(['parameters', 'current_fees', 'scale'])) /
      10000
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        ...
                        <Link to={`account/${account.lifetime_referrer_name}/overview`}>
                    ...
                    <tr>
                      <td>
                        ...
                        <Link to={`account/${account.registrar_name}/overview`}>
                    ...
                    <tr>
                      <td>
                        ...
                        <Link to={`account/${account.referrer_name}/overview`}>
            ...
            <div className="grid-block large-7">
              <div className="grid-content">
                <FeeHelp
                  ...
                  vestingPeriod={
                    gprops.getIn(['parameters', 'cashback_vesting_period_seconds']) / 60 / 60 / 24
                  }
                />
              </div>
            </div>
