    ...
    return (
      <tr>
        ...
        <td className="hide-column-small">
          ...
          <div style={{ paddingTop: 5, fontSize: '0.85rem' }}>
            <a target="_blank" href={worker.url} rel="noreferrer">
              {displayURL}
            </a>{' '}
          </div>
        </td>
        ...
        <td className="hide-column-small">
          ...
          {/* eslint-disable-next-line react/prop-types */}
          {this.props.preferredUnit !== '1.3.0' ? (
        ...
        <td className="hide-column-large">
          {worker.worker[1].balance ? (
            ...
            <span>
              (
              <FormattedAsset
                amount={worker.worker[1].total_burned}
                asset="1.3.0"
                decimalOffset={5}
              />
              )
        ...
        <td className="hide-column-small">{utils.format_number(fundedPercent, 2)}%</td>
        ...
        <td
          style={{
            ...
            textAlign: 'center',
            backgroundColor:
              approvalState === true ? 'green' : approvalState === false ? 'red' : 'transparent',
          }}
        >
          {approval}
        </td>
