          ...
          <div className="grid-content no-overflow medium-offset-2 medium-8 large-offset-3 large-6 small-12">
            ...
            <ul>
              <li>
                ...
                {block ? <FormattedDate value={block.timestamp} format="full" /> : null}
              </li>
              <li>
              ...
              <li>
                <Translate component="span" content="explorer.block.transactions" />:{' '}
                {block ? block.transactions.length : null}
              </li>
            </ul>
            <div className="clearfix" style={{ marginBottom: '1rem' }}>
              <div className="button float-left outline" onClick={this._previousBlock.bind(this)}>
                &#8592;
              </div>
              <div className="button float-right outline" onClick={this._nextBlock.bind(this)}>
                &#8594;
              </div>
            </div>
