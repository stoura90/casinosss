...
class Row extends React.Component {
  ...
  render() {
    ...
    if (block > last_irreversible_block_num) {
      pending = (
        <span>
          (<Translate content="operation.pending" blocks={block - last_irreversible_block_num} />)
        </span>
      )
    }
  ...
  render() {
    ...
    switch (
        ...
        column = (
          <span>
            <TranslateWithLinks
              ...
              keys={[{ type: 'account', value: op[1].fee_paying_account, arg: 'account' }]}
              params={{
        ...
        column = (
          <span>
            <TranslateWithLinks
              ...
              keys={[{ type: 'account', value: op[1].account_to_upgrade, arg: 'account' }]}
            />
          </span>
        )
        break
        ...
        column = (
          <span>
            <TranslateWithLinks
              ...
              keys={[{ type: 'account', value: op[1].witness_account, arg: 'account' }]}
            />
          </span>
        )
      ...
      case 'fill_order':
        ...
        let receivedAmount =
          o.fee.asset_id === o.receives.asset_id
            ? o.receives.amount - o.fee.amount
            : o.receives.amount
        column = (
          <span>
            <TranslateWithLinks
    ...
    if (this.props.csvExportMode) {
      ...
      return (
        <div>
          ...
          <div>{column}</div>
          <div>
            <FormattedAsset amount={parseInt(op[1].fee.amount, 10)} asset={op[1].fee.asset_id} />
          </div>
        </div>
      )
    }
