  ...
  renderAboutBox(asset) {
    module.exports = function (options) {
      ...
      let { name, prefix } = Utils.replaceName(
        asset.symbol,
        'bitasset' in asset && !asset.bitasset.is_prediction_market && asset.issuer === '1.2.0',
      )
      ...
      return (
        <div style={{ overflow: 'visible' }}>
          ...
          <a
            ...
            href={`${!!options.hash ? '#' : ''}/market/${asset.symbol}_${preferredMarket}`}
          >
  ...
  renderSummary(asset) {
    ...
    var stealthSupply = dynamic ? (
      <tr>
        ...
        <td>
          {' '}
          <FormattedAsset amount={dynamic.confidential_supply} asset={asset.id} />{' '}
        </td>
      </tr>
    ) : null
        ...
        <table className="table key-value-table" style={{ padding: '1.2rem' }}>
          <tbody>
            ...
            <tr>
              ...
              <td>
                {' '}
                {dynamic ? <FormattedAsset asset="1.3.0" amount={dynamic.fee_pool} /> : null}{' '}
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                {' '}
                {dynamic ? (
                  <FormattedAsset asset={asset.id} amount={dynamic.accumulated_fees} />
                ) : null}{' '}
              </td>
            </tr>
          </tbody>
    ...
    return (
      <div className="small-12 " style={{ overflow: 'visible', padding: '0.8rem' }}>
        <div className="grid-content">
          <div className="asset-card">
            <div className="card-divider">
              {<Translate content="explorer.asset.price_feed_data.title" />}
            </div>
    ...
    return (
      <div className="grid-block page-layout">
        <div className="grid-block vertical" style={{ overflow: 'visible' }}>
          ...
          <div
            className="grid-block small-12 shrink vertical medium-horizontal"
