      ...
      switch (
        ...
        case 'limit_order_cancel':
          ...
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="explorer.block.fee_payer" />
              </td>
        ...
        case 'call_order_update':
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="transaction.funding_account" />
              </td>
          ...
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="transaction.delta_collateral" />
              </td>
              <td>
                <FormattedAsset
        ...
        case 'account_create':
          ...
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="account.member.registrar" />
              </td>
          ...
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="account.member.lifetime_referrer" />
              </td>
        ...
        case 'account_update':
          ...
          if (op[1].new_options) {
            if (op[1].new_options.voting_account) {
              ...
              rows.push(
                <tr key={key++}>
                  ...
                  <td>
                    <Translate component="span" content="account.votes.no_proxy" />
                  </td>
                </tr>,
              )
              rows.push(
                <tr key={key++}>
                  <td>
                    <Translate component="span" content="account.options.num_committee" />
                  </td>
              ...
              rows.push(
                <tr key={key++}>
                  <td>
                    <Translate component="span" content="account.options.num_witnesses" />
                  </td>
              ...
              rows.push(
                <tr key={key++}>
                  <td>
                    <Translate component="span" content="account.options.votes" />
                  </td>
            ...
            rows.push(
              <tr key={key++}>
                <td>
                  <Translate component="span" content="account.options.memo_key" />
                </td>
          ...
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="explorer.block.common_options" />
              </td>
              <td>
        ...
        case 'account_whitelist':
          ...
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="explorer.block.authorizing_account" />
              </td>
          ...
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="explorer.block.listed_account" />
              </td>
          ...
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="explorer.block.new_listing" />
              </td>
              <td>
        ...
        case 'account_upgrade':
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="explorer.block.account_upgrade" />
              </td>
        ...
        case 'asset_create':
          ...
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="explorer.assets.precision" />
              </td>
          ...
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="account.user_issued_assets.max_supply" />
              </td>
          ...
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="account.user_issued_assets.description" />
              </td>
          ...
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="transaction.max_market_fee" />
              </td>
        ...
        case 'asset_update_bitasset':
          ...
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="explorer.block.asset_update" />
              </td>
          ...
          if (op[1].new_issuer !== op[1].issuer) {
            rows.push(
              <tr key={key++}>
                <td>
                  <Translate component="span" content="account.user_issued_assets.new_issuer" />
                </td>
          ...
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="explorer.block.new_options" />
              </td>
              <td>
        ...
        case 'asset_update_feed_producers':
          ...
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="explorer.block.new_producers" />
              </td>
              <td>{producers}</td>
            </tr>,
          )
        ...
        case 'asset_issue':
          ...
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="explorer.block.asset_issue" />
              </td>
              <td>
                <FormattedAsset
        ...
        case 'asset_publish_feed':
          ...
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="explorer.block.settlement_price" />
              </td>
              <td>
                <FormattedPrice
        ...
        case 'committee_member_create':
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="explorer.committee_member.title" />
              </td>
          ...
          if (op[1].new_url) {
            rows.push(
              <tr key={key++}>
                ...
                <td>
                  <a href={op[1].new_url} target="_blank" rel="noreferrer">
                    {op[1].new_url}
                  </a>
                </td>
              </tr>,
        ...
        case 'balance_claim':
          ...
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="transaction.balance_owner" />
              </td>
        ...
        case 'transfer_to_blind':
          ...
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="transaction.blinding_factor" />
              </td>
        ...
        case 'proposal_create':
          ...
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="proposal_create.review_period" />
              </td>
              <td>
                {has_review_period ? (
                  <FormattedDate value={new Date(review_begin_time)} format="full" />
                ) : (
                  <span>&mdash;</span>
                )}
              </td>
          ...
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="proposal_create.expiration_time" />
              </td>
              <td>
          ...
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="proposal_create.proposed_operations" />
              </td>
              <td>{proposalsText}</td>
            </tr>,
          )
          rows.push(
            <tr key={key++}>
              <td>
                <Translate component="span" content="proposal_create.fee_paying_account" />
              </td>
              <td>{this.linkToAccount(op[1].fee_paying_account)}</td>
            </tr>,
          )
