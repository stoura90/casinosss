    ...
    let last_aslot_time = new Date(
      Date.now() -
        ...
        (this.props.most_recent - witness_aslot) *
          ChainStore.getObject('2.0.0').getIn(['parameters', 'block_interval']) *
          1000,
    )
      ...
      <div className="grid-content account-card" onClick={this._onCardClick.bind(this)}>
        <div className="card" style={color}>
          <h4 className="text-center">
            {/* eslint-disable-next-line react/prop-types */}
            {/* eslint-disable-next-line react/prop-types */}#{this.props.rank}:{' '}
    ...
    if (!cardView) {
      return (
        <table className="table table-hover">
          <thead>
            <tr>
              <th className="clickable" onClick={this._setSort.bind(this, 'rank')}>
                <Translate content="explorer.witnesses.rank" />
              </th>
              <th className="clickable" onClick={this._setSort.bind(this, 'name')}>
                <Translate content="account.votes.name" />
              </th>
              <th className="clickable" onClick={this._setSort.bind(this, 'last_aslot')}>
              ...
              <th className="clickable" onClick={this._setSort.bind(this, 'total_missed')}>
                <Translate content="explorer.witnesses.missed" />
              </th>
              <th className="clickable" onClick={this._setSort.bind(this, 'total_votes')}>
      ...
      return <div className="grid-block small-up-1 medium-up-2 large-up-3">{itemRows}</div>
    }
  }
}
              ...
              <table className="table key-value-table">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      {' '}
                      <FormattedAsset amount={dynGlobalObject.witness_budget} asset="1.3.0" />
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      {' '}
                      <TimeAgo time={new Date(dynGlobalObject.next_maintenance_time)} />
                    </td>
                  </tr>
                  <tr>
                    <td>
