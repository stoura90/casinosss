...
class Blocks extends React.Component {
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    ...
    if (
      ...
      // eslint-disable-next-line react/prop-types
      nextProps.dynGlobalObject.get('head_block_number') !== nextProps.latestBlocks.get(0).id
    ) {
      ...
      <div ref="outerWrapper" className="grid-block vertical page-layout">
        ...
        <div className="align-center grid-block shrink small-horizontal blocks-row">
          <div className="grid-block text-center small-6 medium-3">
            <div className="grid-content no-overflow">
              <span className="txtlabel subheader">
                <Translate component="span" content="explorer.blocks.current_block" />
              </span>
          ...
          <div className="grid-block text-center small-6 medium-3">
            <div className="grid-content no-overflow">
              <span className="txtlabel subheader">
                <Translate component="span" content="explorer.blocks.last_block" />
              </span>
          ...
          <div className="grid-block text-center small-6 medium-3">
            <div className="grid-content no-overflow">
              <span className="txtlabel subheader">
                <Translate component="span" content="explorer.blocks.trx_per_sec" />
              </span>
          ...
          <div className="grid-block text-center small-6 medium-3">
            <div className="grid-content no-overflow">
              <span className="txtlabel subheader">
                <Translate component="span" content="explorer.blocks.avg_conf_time" />
              </span>
        ...
        <div className="align-center grid-block shrink small-horizontal  blocks-row">
          <div className="grid-block text-center small-6 medium-3">
            <div className="grid-content no-overflow clear-fix">
              <span className="txtlabel subheader">
                <Translate component="span" content="explorer.blocks.active_witnesses" />
              </span>
              <h2 className="txtlabel success">{globalObject.get('active_witnesses').size}</h2>
            </div>
          </div>
          ...
          <div className="grid-block text-center small-6 medium-3">
            <div className="grid-content no-overflow clear-fix">
              <span className="txtlabel subheader">
                <Translate component="span" content="explorer.blocks.active_committee_members" />
              </span>
          ...
          <div className="grid-block text-center small-6 medium-3">
            <div className="grid-content no-overflow clear-fix">
              <span className="txtlabel subheader">
                <Translate component="span" content="explorer.blocks.recently_missed_blocks" />
              </span>
          ...
          >
            <div className="grid-block vertical no-overflow generic-bordered-box">
              ...
              <div
                ...
                style={{ maxHeight: operationsHeight || '400px', overflow: 'hidden' }}
                /* eslint-disable-next-line react/no-string-refs */
                ref="operations"
              >
                <table className="table">
          ...
          >
            <div className="grid-block vertical no-overflow generic-bordered-box">
              ...
              <div
                ...
                style={{ maxHeight: blocksHeight || '438px', overflow: 'hidden' }}
                /* eslint-disable-next-line react/no-string-refs */
                ref="blocks"
              >
                <table className="table">
                  <thead>
                    <tr>
                      <th>
                        <Translate component="span" content="explorer.block.id" />
                      </th>
                      <th>
                      ...
                      <th>
                        <Translate component="span" content="explorer.block.count" />
                      </th>
                    </tr>
                  </thead>
