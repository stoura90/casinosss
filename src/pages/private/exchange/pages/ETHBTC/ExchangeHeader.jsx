...
export default class ExchangeHeader extends React.Component {
  ...
  render() {
    ...
    const dayChangeClass =
      parseFloat(dayChange) === 0 ? '' : parseFloat(dayChange) < 0 ? 'negative' : 'positive'
    const dayChangeArrow =
      dayChangeClass === '' ? '' : dayChangeClass === 'positive' ? 'change-up' : 'change-down'
    ...
    let bucketOptions = buckets
      ...
      .map((bucket) => {
        return (
          <div
            key={bucket}
            className={cnames('label bucket-option', { 'active-bucket': bucketSize === bucket })}
    ...
    let zoomOptions = zoomPeriods.map((period) => {
      return (
        <div
          key={period}
          className={cnames('label bucket-option', { 'active-bucket': currentPeriod === period })}
      ...
      <div className="grid-block shrink no-padding overflow-visible top-bar">
        <div className="grid-block no-overflow">
          ...
          <div className="grid-block vertical">
            <div
              className="grid-block show-for-medium wrap"
            ...
            >
                  ...
                  <span>
                    ...
                    <b className={'value ' + dayChangeClass}>
                      ...
                      <span className={dayChangeArrow}>
                        &nbsp;
                        {dayChangeArrow === '' ? null : dayChangeArrow === 'change-up' ? (
                          <span>&#8593;</span>
                        ) : (
                          <span>&#8595;</span>
                        )}
              ...
              <div className="grid-block" style={{ minHeight: 39, justifyContent: 'flex-end' }}>
                <ul className="float-right market-stats stats top-stats">
                  <li
                    className="stat float-right clickable"
                    style={{
                      height: '100%',
            ...
            <div
              className="grid-block wrap no-overflow"
              ...
              <ul className="market-stats stats bottom-stats">
                ...
                {onBorrowQuote ? (
                  <li
                    ...
                    style={{ borderLeft: '1px solid grey', borderRight: 'none' }}
                    onClick={onBorrowQuote}
                  >
                    <div className="indicators">
